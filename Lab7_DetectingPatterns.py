...
We'll practice moving from raw counts to conditional distributions, and detect patterns in typological data while critically evaluating whether observed patterns support linguistic theories.
...
SOV (subject, object, verb) appears the most followed by SVO (subject, verb, object). This ordering matches my initial intuition. So far I cannot see any patterns with this dataset. 
